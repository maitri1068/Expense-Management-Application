 ...
 const ITEM_HEIGHT=48
  ...
  async function handleyear(val) {
    ...
    try {
      ...
      let i1 = await axios.post("http://localhost:1010/incomeperiod", {
        year: val,
        userid: id,
        period: period
      }, {
  ...
  async function handlechart(val,period,year) {
    ...
    console.log(val,sdate,period,year)
  ...
  async function getdata() {
    ...
    try {
      let i = await axios.post("http://localhost:1010/expensereport", {
      ...
      let i1 = await axios.post("http://localhost:1010/incomereport", {
        startdate: formik.values.startdate,
        enddate: formik.values.enddate,
      }, {
        headers: {
