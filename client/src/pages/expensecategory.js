...
import "../cssfiles/expensecategory.css";
import {
  Box,
  Grid,
  InputLabel,
...
export default function Expensecategory() {
  ...
  async function getcategorylist() {
    ...
    try {
      let i = await axios.post("http://localhost:1011/categorylist", {
        userid: id,
      },
      {
        headers: {
  ...
  async function getdata() {
    ...
    try {
      let i1 = await axios.post("http://localhost:1011/dailycategory", {
        userid: id,
      },{
        headers: {
          authorization: `Bearer ${item.value}`,
  ...
  async function handlecategory(val) {
    ...
    try {
      let i = await axios.post("http://localhost:1011/categoryinformation", {
        month:m,
        year:year,
        userid: id,
        category: val,
  ...
  async function handleyear(val) {
    ...
    try{
    const i=await axios.post('http://localhost:1011/expenseyear',{
      userid:id,
      month:m,
      year:val,
      category:category
...
try{
  let i = await axios.post("http://localhost:1011/expenseyear", {
    year: year,
    userid: id,
    month: m,
    category:category
